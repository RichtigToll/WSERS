...
INSERT INTO Descriptions (DescText, ProductID, LanID, DescText2) VALUES ("SPIELE ALL DIE HIGHLIGHT SPIELE - IN HD - ÜBERALL!", 1, 1, "Mit dem neuen OLED Display Technologie und der höheren Akku Kapazität, kannst du die atemberaubende Nintendo Spiele spielen aber in ANDERS! Du kannst auf dieser Switch Mehrspieler Spiele spielen. EGAL WO!");
INSERT INTO Descriptions (DescText, ProductID, LanID, DescText2) VALUES ("4K - 120Hz SPIELE!", 2, 1, "Du willst eine PS5 kaufen? Tja pech, gibt es nicht");
INSERT INTO Descriptions (DescText, ProductID, LanID, DescText2) VALUES ("BESICHTIGE NEUE WELTEN - IN VIRTUAL REALITY!", 3, 1, "Fühlst du dich von der realen Welt depressiv? VERSTECK DICH IN EINER ANDEREN WELT!");
INSERT INTO Descriptions (DescText, ProductID, LanID, DescText2) VALUES ("ENTDECKE DIE FORZA HORIZON WELT IN ULTRA HD!", 4, 1, "SPIELE DIE BELIEBTESTEN SPIELE WIE FORZA HORIZON 5 IN QHD/120 BILDER PRO SEKUNDE - DAZU NOCH XBOX GAME PASS für 3 MONATE!");